...
const ContactManufacturerForm: React.FC<ContactManufacturerFormProps> = ({
  ...
  const handleTabChange = (value: string) => {
    try {
      ...
      // Fallback to message tab if there's an error
      setActiveTab("message");
    }
  };
        ...
        {(manufacturer.email || manufacturer.phone || manufacturer.website) ? (
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button 
                            ...
                            onClick={() => {
                              try {
                                window.location.href = `mailto:${manufacturer?.email || ''}`;
                              } catch (error) {
          ...
          >
              ...
              <Button 
                ...
                onClick={() => {
                  try {
                    const url = manufacturer?.website || '';
            ...
            <div className={`mt-4 flex gap-2 ${isDarkMode ? "text-amber-400" : "text-amber-600"}`}>
              <Clock size={16} />
      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} defaultValue="message" className="w-full">
              ...
              <div key={activeTab} className="animate-in fade-in duration-200">
                {activeTab === "message" ? renderMessageTab() : null}
